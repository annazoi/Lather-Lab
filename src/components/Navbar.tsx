...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-[#E6EDE4]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex justify-between items-center h-20">
        ...
        <div className="flex-1 lg:flex-none flex items-center lg:justify-start justify-center">
          <a href="/" className="text-xl md:text-2xl font-serif text-stone-900 font-bold tracking-widest flex items-center space-x-1">
            <span>TERRA</span>
        ...
        <div className="hidden lg:flex flex-1 justify-center space-x-12">
          {["HOME", "PHILOSOPHY", "COLLECTIONS", "INGREDIENTS"].map((link) => (
            <a
              key={link}
              href="#"
