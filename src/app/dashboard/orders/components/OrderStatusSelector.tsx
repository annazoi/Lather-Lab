...
export default function OrderStatusSelector({ orderId, currentStatus }: StatusSelectorProps) {
	...
	return (
		<div className={`relative inline-block text-left min-w-[140px] ${isOpen ? 'z-50' : 'z-auto'}`}>
			...
			{isOpen && (
				<div className="fixed max-w-fit z-50 mt-2 w-full origin-top-right rounded-lg bg-[#23211F] border border-[#363330] shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-1 duration-200">
					<div className="py-1">
