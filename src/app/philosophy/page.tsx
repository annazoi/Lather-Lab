		...
		<main className="min-h-screen pt-20 bg-[#F9F8F6] text-stone-900">
			...
			<section className="py-24 max-w-4xl mx-auto px-6 lg:px-12 text-center text-stone-800 space-y-16">
				<div className="space-y-8">
					<h2 className="font-serif text-3xl md:text-4xl text-stone-900">A Return to Simplicity</h2>
					<div className="w-16 h-[1px] bg-stone-400 mx-auto" />
					<p className="font-sans text-stone-600 leading-loose text-[15px] font-light">
						At Lather Lab, we believe that skincare should be an uncomplicated ritual. We source our ingredients
						directly from the earth, stripping away the unnecessary synthetics, artificial fragrances, and harsh
						chemicals that dominate modern cosmetics.
					</p>
					<p className="font-sans text-stone-600 leading-loose text-[15px] font-light">
						Our artisanal process is a labor of love. Every small batch is cured slowly to ensure maximum potency
						and gentleness, resulting in a product that nourishes the skin and respects the environment.
					</p>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-12 pt-12 border-t border-stone-200">
					...
					<div className="space-y-4">
						...
						<p className="text-sm text-stone-500 leading-relaxed font-light">
							Each bar is hand-poured, hand-cut, and cured for weeks. True quality takes time and cannot be
							rushed.
						</p>
					</div>
				</div>
